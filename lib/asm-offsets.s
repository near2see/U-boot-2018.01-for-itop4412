	...
	.file	"asm-offsets.c"
@ GNU C11 (Linaro GCC 7.2-2017.11) version 7.2.1 20171011 (arm-linux-gnueabihf)
...
@ -iprefix /usr/local/arm/gcc-linaro-7.2/bin/../lib/gcc/arm-linux-gnueabihf/7.2.1/
@ -isysroot /usr/local/arm/gcc-linaro-7.2/bin/../arm-linux-gnueabihf/libc
@ -D __KERNEL__ -D __UBOOT__ -D __ARM__ -D __LINUX_ARM_ARCH__=7
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /usr/local/arm/gcc-linaro-7.2/bin/../lib/gcc/arm-linux-gnueabihf/7.2.1/include
...
.LASF167:
	.ascii	"/home/near/Desktop/U-boot-2018.01-itop4412\000"
.LASF146:
...
.LASF10:
	.ascii	"short int\000"
.LASF165:
	.ascii	"GNU C11 7.2.1 20171011 -marm -mno-thumb-interwork -"
	...
	.ascii	"builtin -ffreestanding -fshort-wchar -fno-stack-pro"
	.ascii	"tector -fno-delete-null-pointer-checks -fstack-usag"
	.ascii	"e -fno-pic -ffunction-sections -fdata-sections -fno"
